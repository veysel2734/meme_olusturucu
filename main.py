...
def index():
    if request.method == 'POST':
        ...
        text_top_y = request.form.get("textTop_y")  # Değişken adı HTML ile uyumlu hale getirildi
        text_bottom_y = request.form.get("textBottom_y")  # Değişken adı HTML ile uyumlu hale getirildi

        # Görev #3. Metnin rengini almak
        selected_color = request.form.get("color-selector")  # Doğru isim kullanıldı
